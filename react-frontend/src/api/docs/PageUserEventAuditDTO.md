...
**content** | [**Array&lt;UserEventAuditDTO&gt;**](UserEventAuditDTO.md) |  | [optional] [default to undefined]
...
```typescript
import { PageUserEventAuditDTO } from 'api-client';

const instance: PageUserEventAuditDTO = {
    totalElements,
    totalPages,
    size,
    content,
