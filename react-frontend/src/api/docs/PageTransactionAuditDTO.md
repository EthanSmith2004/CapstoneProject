...
**content** | [**Array&lt;TransactionAuditDTO&gt;**](TransactionAuditDTO.md) |  | [optional] [default to undefined]
...
```typescript
import { PageTransactionAuditDTO } from 'api-client';

const instance: PageTransactionAuditDTO = {
    totalElements,
    totalPages,
    size,
    content,
